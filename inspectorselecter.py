...
class IsolationWindow(form_class, base_class):
	...
	def refreshViewBtns(self):
		...
		self.panelLocations = self.getPanelLocations()
...
class ViewRefreshFilter(QtCore.QObject):
	...
	# This could probably be part of a maya callback. but maya callbacks are lame, and not seeming to work well
...
class MemoryClickFilter(QtCore.QObject):
	...
	# I'm sure this could override a mouseRelease() method on the btn instead. this is fine for now
